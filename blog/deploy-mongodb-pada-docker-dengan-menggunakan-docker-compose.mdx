...
<Aside type="tip">
Pastikan Anda telah menginstal Docker dan Docker Compose sebelum menjalankan perintah berikut.
</Aside>
...
Setelah MongoDB berjalan, Anda dapat mengaksesnya dengan klien MongoDB atau tools seperti **Robo 3T**.

<Aside type="note">
Pastikan firewall dan aturan keamanan jaringan Anda mengizinkan koneksi ke MongoDB jika ingin diakses dari luar container.
</Aside>
