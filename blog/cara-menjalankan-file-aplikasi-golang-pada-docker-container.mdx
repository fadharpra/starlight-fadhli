...
author: "fadharpra"
date: 2023-04-18 13:06:00
cover:
  alt: Docker and Go logo.
  image: ../../assets/blog-cover/docker-golang.jpg
excerpt: Pada artikel ini akan menjelaskan bagaimana cara menjalankan sebuah file aplikasi yang sudah di-build sebelumnya dengan Golang kemudian menjalankannya didalam Docker Container.
tags:
  - Docker
  - Docker Compose
  - Containerization
