---
title: "Lab Praktik: Provision Vertex AI Workbench dengan Terraform"
author: "fadharpra"
...
Beberapa waktu lalu, gue diminta jadi narasumber/fasilitator untuk sesi **Code & Create - Build with AI Workshops Session 2** di event **Google I/O Extended Bogor 2025**.

Sebagai orang yang kerja di bidang **system engineering dan infrastruktur**, jujur aja waktu disuruh pake topiknya ada embel-embel **AI**, gue langsung mikir:
> *“Waduh... ini di luar zona nyaman gua banget.”*

Gue nggak punya latar belakang ML/Data Science, dan jujur agak struggle buat ngerti service-service AI di GCP.

Tapi di sisi lain, gue juga punya keinginan kuat buat **tetap bisa sharing sesuatu yang relevan** dari perspektif gue sebagai orang infra; yaitu tentang **automation dan provisioning tools seperti Terraform**.

Akhirnya gue ambil kesempatan ini sebagai tantangan:
- Gue belajar pake Vertex AI Workbench
- Gue cobain provisioning-nya dari nol
- Dan gue ramu semuanya ke dalam **lab praktis yang fokus ke automation**, bukan modeling atau training berat

🧠 Dan justru dari situ gue belajar satu hal penting:  
