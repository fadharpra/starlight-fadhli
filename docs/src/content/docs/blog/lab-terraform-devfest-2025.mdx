...
// Kalau kalian simpan file TF ini sebagai asset biar bisa di-render pakai <Code />,
// taro file-nya di /src/assets/code/terraform-devfest-dev-demo/ lalu uncomment import di bawah.
// import providersTf from "/src/assets/code/terraform-devfest-dev-demo/providers.tf?raw";
// import variablesTf from "/src/assets/code/terraform-devfest-dev-demo/variables.tf?raw";
// import mainTf from "/src/assets/code/terraform-devfest-dev-demo/main.tf?raw";
